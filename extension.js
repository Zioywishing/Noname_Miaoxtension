game.import("extension",function(lib,game,ui,get,ai,_status){return {name:"喵喵喵喵",content:function (config, pack) {
            /*---------------------------------------------------------------以下为杂项---------------------------------------------------------------*/
		...
		},precontent:function () {},help:{},config:{},package:{
    character:{
        character:{
...
if(get.type(card)=='basic' && get.type(card)=='trick')   flag=  true;
            ...
            "zioy_yuezhuiyunwei":{
                ...
                group:["zioy_yuezhuiyunwei_0","zioy_yuezhuiyunwei_501","zioy_yuezhuiyunwei_502","zioy_yuezhuiyunwei_1","zioy_yuezhuiyunwei_6","zioy_yuezhuiyunwei_eq"],
                subSkill:{
                    "0":{
                        trigger:{
                            global:["phaseBegin"],
        ...
        player.addSkill('zioy_v07yuxie_yuxie');
            ...
            "zioy_pinghuqiuyue":{
                ...
                group:["zioy_pinghuqiuyue_damage2hujia","zioy_pinghuqiuyue_damageEndS","zioy_pinghuqiuyue_damageEndP","zioy_pinghuqiuyue_damageLimit","zioy_pinghuqiuyue_phaseEnd","zioy_pinghuqiuyue_dyingBegin"],
                subSkill:{
                    noLoseHp:{
                        trigger:{
                            player:"loseHpBegin",
        ...
        if(game.roundNumber%2 == 1){
            ...
            "zioy_yongyeqingxiao":{
                ...
                mod:{
                    globalFrom:function(from,to,distance){
                        if(from.countMark("zioy_yongyeqingxiao") == 0)
                            return distance-1;
                    },
                    cardUsable:function(card,player,num){
        ...
        translate:{
            ...
            "zioy_chenmeng":"尘梦",
            "zioy_chenmeng_info":"锁定技，其他角色造成伤害时，你令其失去一点体力上限并获得〖尘〗标记，然后你获得一点体力上限。你对拥有〖尘〗标记的角色造成伤害时，你移除其〖尘〗标记，恢复其以此法失去的体力上限，然后其失去一点体力，你获得其一张手牌，回复1点体力并失去以此法获得的体力上限。",
            "zioy_chenmeng1":"尘梦",
            ...
            "zioy_huashou":"花狩",
            "zioy_huashou_info":"锁定技，你的回合开始阶段，你随机标记一名敌人并将其区域内随机2/3数量的牌(向上取整)置于其武将牌上。若你回合内对被标记者造成伤害，你移除其标记，对其造成X点伤害，回复X/2（向下取整）点体力，若X/2大于你已损失体力则将你的护甲置为1，然后获得其以此法置于武将牌上的所有牌。若回合结束时其未受到伤害，其获得其武将牌上的所有牌。（X为受伤角色已损失体力）",
            "zioy_huashou2":"花狩",
            "zioy_huashou2_info":"若你本回合未受到伤害，回合结束时获得被〖花狩〗置于武将牌上的牌。",
            "zioy_huashou3":"花狩",
            "zioy_huashou3_info":"",
            "zioy_longyue":"胧月",
            "zioy_longyue_info":"游戏开始时，你摸一张牌并创建一张【月光】，你的出牌阶段开始时，你装备你游戏开始时创建的【月光】。你对被〖花狩〗标记的角色造成伤害会提升你的基础属性: 第一次造成伤害时：你装备的【月光】提供的攻击范围+1，每2次造成伤害：你的手牌上限+1，每3次造成伤害：你的摸牌阶段摸牌数+1，每4次造成伤害：你的体力上限+1。",
            "zioy_longyue2":"胧月",
            "zioy_longyue2_info":"",
            "zioy_jike":"棘壳",
            ...
            "zioy_happyNewYear_info":"锁定技，当你失去牌时，你获得一个\"春\"标记。当你的\"春\"标记数量发生变化时，若标记数量为偶数，你摸一张牌。当你于你的回合内使用【杀】指定目标时，若你的\"春\"标记数量大于等于X，你需弃置X个\"春\"标记，并使你此次使用的【杀】不计入出牌阶段使用次数(X在你的出牌阶段第一次使用牌时被赋值为4，且每次使用此技能令【杀】不计入次数时+2)。",
            "zioy_qunyou2":"逡游",
            "zioy_qunyou2_info":"春节快乐，于2023.1.21，8:37。",
            "zioy_qianlong":"潜龙",
            "zioy_qianlong_info":"当你使用或打出一张【杀】或【闪】时，若你区域内有牌，你可以弃置一张牌，然后你摸一张牌并获得一点护甲",
            "zioy_jianlong":"见龙",
            "zioy_jianlong_info":"出牌阶段，若你护甲值大于0，你可以摸一张牌并移去一点护甲。若此做，你的下一张【杀】无视距离且若此【杀】造成伤害，你将此技能替换为〖飞龙〗。",
            "zioy_feilong":"飞龙",
            "zioy_feilong_info":"锁定技，除非该角色死亡，你的【杀】只能对你上一次使用【杀】造成伤害的角色使用。你的下一张【杀】无距离限制且无法被响应。若你使用【杀】对一名角色造成伤害，你失去【飞龙】并获得【亢龙】，【见龙】，然后你摸一张牌。",
            "zioy_kanglong":"亢龙",
            "zioy_kanglong_info":"限定技，出牌阶段，你可以选择一名角色，你摸一张牌，并对该角色造成X点伤害，若该角色因〖亢龙〗死亡，则你的〖亢龙〗视为未使用(X为你当前体力值与该角色当前体力值的差值且至少为1)",
            "zioy_jianlong2":"见龙",
            ...
            "zioy_xuanzhuan":"璇转",
            "zioy_xuanzhuan_info":"出牌阶段限一次，你可以令场上所有有手牌的角色将一张手牌置于你的武将牌上，然后对于你武将牌上的每张牌，你令随机一名刚才有将牌置入你的武将牌上的角色获得之，你有更大的概率获得。",
            "zioy_leiye1":"累业",
            ...
            "zioy_shuangsha_info":"觉醒技，与〖霜杀墨染雪〗共用次数。出牌阶段，若你的\"霜\"标记达到3，你可以获得一点体力上限，回复2点体力并选择一名角色，你对其造成一点伤害。",
            "zioy_lieying":"裂影",
            "zioy_lieying_info":"当你造成伤害时，你可以摸一张牌。若你使用过〖霜杀墨染雪〗，你的【杀】不可被响应且你造成的伤害+1。若你使用过〖墨残霜伴樱〗，你的【杀】可以额外指定一个目标，当你造成伤害时，你回复X点体力值(X为你已损失体力值/2，向下取整)",
            "zioy_lieying1":"裂影",
            "zioy_lieying1_info":"",
            "zioy_wrjzc":"无人机侦查",
            "zioy_wrjzc_info":"回合开始阶段，你观看随机一名角色的手牌。",
            "zioy_zsyhj":"自适应护甲",
            "zioy_zsyhj_info":"锁定技，你的手牌上限等于你的护甲，每个回合开始阶段，你大于1的体力上限会被转化为护甲。当你受到一次属性伤害，你免疫下一次属性伤害。当你受到一次无属性伤害，你免疫下一次无属性伤害。两种免疫效果不能同时存在。",
            "zioy_weixiang":"伪像",
            "zioy_weixiang_info":"游戏开始时，你选择一名角色，然后你将你的武将牌替换成你选择角色的武将牌，同时修改自己的体力，体力上限，护甲与其一致。",
            "zioy_zsyhjn":"护甲",
            "zioy_zsyhjn_info":"抵消下一次受到的属性伤害",
            "zioy_fansheng":"反生",
            "zioy_fansheng_info":"锁定技，你死亡时，杀死你的角色获得〖年种〗标记并将体力上限减少至1，然后你废除其防具栏，+1马栏，宝物栏。若拥有你给予的〖年种〗标记的角色死亡，你复活并令你回复X点体力，增加X点体力上限，摸X张牌，然后你与其交换座位并进行一个额外的回合(X为〖年种〗标记的角色原有的体力上限)",
            "zioy_nianzhong":"年种",
            ...
            "zioy_moying":"末影",
            "zioy_moying_info":"出牌阶段限一次，你可以将一张黑色牌置于一名角色的武将牌上，称为\"末影\"，当你使用牌指定一名其他角色为唯一目标时，拥有\"末影\"且不为目标的角色视为对目标使用一张与你使用牌相同的牌。场上至多同时存在2个由你产生的\"末影\"，当\"末影\"超出限制时，你获得已存在最早产生的\"末影\"。",
            "zioy_yingdun":"影遁",
            "zioy_yingdun_info":"当你成为一名角色使用牌的目标时，你可以选择一名不为此牌目标且拥有\"末影\"的角色，你将此牌目标转移为该角色并与其交换座位，每个\"末影\"限一次，重新赋予\"末影\"可刷新限制。",
            "zioy_moying2":"末影",
            ...
            "zioy_douzhuan":"斗转",
            "zioy_douzhuan_info":"游戏开始时，你随机指定一名角色并将7张牌置于其武将牌上，称为“星斗”。每轮游戏开始时，星斗将转移至拥有者下家。当“星斗”拥有者死亡或一轮游戏开始时你为满月且与“星斗”拥有者的座位相邻时，你获得“星斗”中的所有牌，使你月相的额外摸牌效果翻倍并使你的手牌上限+7。",
            "zioy_xingdou":"星斗",
            ...
            "zioy_nianxi":"年袭",
            "zioy_nianxi_info":"出牌阶段，你可以弃置一张非红色牌，视为打出一张【杀】，若此杀未造成伤害，你受到由目标角色对你造成的X点伤害(X为你因此技能受到伤害的次数+1)",
            "zioy_nianxi2":"年袭",
            "zioy_nianxi2_info":"",
            "zioy_xiantong":"显瞳",
            "zioy_xiantong_info":"一轮游戏开始或你的摸牌阶段结束时，你可以将一张非装备牌置于你的武将牌上，称为“瞳”。你拥有的“瞳”的数量不能超过你的体力上限。你的回合结束阶段，对于你的每张“瞳”，你视为对随机一名其他角色使用一张虚拟的同名牌。",
            "zioy_xiane":"显厄",
            "zioy_xiane_info":"回合结束阶段，若你的“瞳”达到3张，你可以依次获得你的所有“瞳”，你每以此法获得一张“瞳”，随机一名其他角色受到由你造成的2点雷电伤害。",
            "zioy_xiantong2":"显瞳",
            "zioy_xiantong2_info":"结束阶段",
            "zioy_wuya":"雾鸦",
            "zioy_wuya_info":"出牌阶段，你可以失去一点体力上限并选择一名角色，你令其获得“鸦”标记。拥有“鸦”标记的角色所有技能失效。拥有“鸦”标记的角色即将受到伤害时，防止此伤害并移去“鸦”标记。拥有“鸦”标记的角色的回合开始阶段，你需将此标记转移给一名未拥有“鸦”的角色。你以此法转移“鸦”标记时，原被标记者失去一点体力。若你以此法将“鸦”标记转移到自己区域内，你失去“鸦”标记，回复X点体力，并获得X点“黑血”标记（X为此“鸦”标记转移的次数+1）",
            "zioy_sheji":"摄脊",
            "zioy_sheji_info":"当你使用【杀】指定一名角色为目标时，你可以失去一点“黑血”，然后令【杀】失效，你偷取目标角色一点体力值。",
            "zioy_puai":"瀑霭",
            "zioy_puai_info":"限定技，回合结束阶段，你可以移去任意点“黑血”并失去等量体力上限，然后从下轮游戏开始，持续X轮，获得以下效果：<br>①.“鸦”不被强制要求抵挡伤害 <br>②.“鸦”不被强制要求移动 <br>③.发动〖雾鸦〗时失去体力上限改为获得体力上限。 <br>④.你与其他角色的距离为负无穷大，其他角色与你的距离为无穷大，防止你成为伤害类卡牌的目标。",
            "zioy_wuya2":"雾鸦",
            "zioy_wuya2_info":"",
            "zioy_wuya3":"雾鸦",
            "zioy_wuya3_info":"",
            ...
            "zioy_cangzhen2_info":"",
            "zioy_shangqin":"上觐",
            "zioy_shangqin_info":"锁定技，①当有其他非“虚空虫”角色死亡后，你可令其复活并将武将牌替换为“虚空虫”，其体力上限与体力值为2，身份与你同阵营，操控者为你。然后你获得一点体力上限并回复一半已损失体力（向上取整）<br>②“虚空虫”死亡后，你获得其所有牌。",
            "zioy_hanshou":"颔首",
            "zioy_hanshou_info":"限定技，一轮游戏开始时，你可以令所有已死亡的“虚空虫”满体力复活，然后你失去X点体力上限并令所有“虚空虫”摸X张牌（X为以此法复活的“虚空虫”数量）",
            "zioy_shangqin2":"上觐",
            "zioy_shangqin2_info":"",
            "zioy_shangqin3":"上觐",
            "zioy_shangqin3_info":"",
            ...
            "zioy_longzi_info":"",
            "zioy_yingyuan":"隐渊",
            "zioy_yingyuan_info":"①其他角色的回合结束阶段开始时，若你的武将牌为正面朝上，你可以将你的武将牌翻面。<br>②每轮游戏限一次，已受伤角色的回合结束阶段，若你武将牌翻面，你可以重复和你的下家交换位置直到你成为此受伤角色的上家，然后你将武将牌翻面并立即执行一个额外的回合<br>③若你武将牌背面向上，你即将受到的伤害-1。",
            "zioy_hey":"嘿！",
            "zioy_hey_info":"每名角色每轮限一次，回合开始与结束阶段，你选择一种颜色并观看一名角色的手牌，若其手牌中你选择颜色数量占优/不占优，你与其各摸/弃置一张牌并令其/你“光芒”标记拥有状态取反。获得此技能时你获得“光芒”。",
            "zioy_ya":"呀！",
            "zioy_ya_info":"你即将受到伤害时，若你没有“光芒”，你可以将一枚“光芒”移动至你的区域内并防止此次伤害。",
            "zioy_ha":"哈！",
            "zioy_ha_info":"你造成伤害后，你可以移动一枚“光芒”标记。",
            "zioy_guangmang":"光芒",
            "zioy_guangmang_info":"锁定技，①受到伤害结算后，若场上存在其他拥有“光芒”的角色，你移去“光芒”并对其中随机一名角色造成等于本次伤害值的伤害。<br>②无“光芒”角色与你的距离为无穷大。",
            "zioy_shihong":"拾虹",
            "zioy_shihong_info":"锁定技，摸牌阶段，未觉醒状态下你可以额外摸0~Y张牌，并弃置一名角色X张牌，觉醒状态下召唤曙光天气N回合（N为当前存活角色数，Y为N/2且向上取整，X为Y-本回合以此法额外摸牌的数量）",
            "zioy_cuiyi":"皠翊",
            "zioy_cuiyi_info":"回合开始阶段，未觉醒状态下令一名角色“皠翊”标记拥有状态取反，然后根据游戏轮数强化拥有“皠翊”标记的角色2项属性1级。觉醒状态下锁定所有拥有“皠翊”标记的角色强化N回合（N为当前存活角色数）",
            "zioy_shulin":"倏翷",
            "zioy_shulin_info":"觉醒技，每局游戏限2次。出牌阶段开始时，你可以回复所有已损失体力并进入觉醒状态。再次使用此技能时回复X点体力并将多出的回复值转化为摸牌数，然后你退出觉醒状态（X为觉醒状态持续时间）",
            "zioy_huangyi":"煌熠",
            "zioy_huangyi_info":"锁定技，你即将造成伤害时，未觉醒状态下你令伤害-1并回复1点体力，觉醒状态下若目标角色强化锁定则解除锁定，然后倒置目标角色强化，令伤害+X(X为你以此法倒置的强化项数之和)",
            "zioy_t":"测试",
            "zioy_t_info":"测试技能",
            "zioy_t1":"测试",
            "zioy_t1_info":"sadadwadwaedaw",
            "zioy_shuohui":"朔回",
            "zioy_shuohui_info":"锁定技<br>①防止你在已损失体力时死亡，你在未损失体力时进入濒死状态。<br>②你不以此法失去体力与受到伤害均改为回复体力，不以此法回复体力均改为失去体力。<br>③除开始阶段与结束阶段，你的回合阶段执行顺序与正常顺序相反。<br>④你的手牌上限等于你已损失体力。",
            "zioy_hexuchongxiang":"鹤墟重香",
            "zioy_hexuchongxiang_info":"清香更何用，犹发去年枝。<br>①将你即将受到伤害/流失体力时伤害/流失值超过X点的部分转化为“蜃气”，触发此效果超过X+1次后令X翻倍（若X=0则令X加1）并重置计数（获得此技能时令X=0）<br>②当你死亡时，若你体力值不小于0则改为失去所有体力，否则：若你体力上限不为场上唯一最多，你复活，获得N+1点体力上限，回复所有体力，移去所有“蜃气”并获得等量护盾，摸等量的牌，令X等于N-1，重置①效果计数，令你本局游戏摸牌阶段摸牌数，造成/受到伤害，失去体力的数值永久增加80%（向下取整）（N为〖鹤墟重香②〗发动的次数）<br>③你的“蜃气”数量不会超过你体力上限，获得“蜃气”时根据你是否受伤将多余的“蜃气”转换为体力值或“海市蜃楼”天气回合数。",
            "zioy_hexuchongxiang_mark":"鹤墟重香③",
            "zioy_hexuchongxiang_revive":"鹤墟重香②",
            "zioy_yuezhuiyunwei":"月坠云微",
            "zioy_yuezhuiyunwei_info":"梦回芳草思依依，天远雁声稀。<br>①根据当前“蜃气”的数量执行下列效果：<br>不大于50%体力上限：一名角色的回合开始阶段你失去1级防御，攻击强化，你的判定区视为被废除，你免疫任何异常状态，你的武将牌始终正面向上。<br>大于25%体力上限：当你成为其他角色使用牌的目标时，其弃置一张与此牌同名的手牌（没有则不弃）<br>大于6：当你造成超过1点伤害后，你失去1点体力上限并令其获得1点体力上限，令你本局游戏摸牌阶段摸牌数，造成/受到伤害，失去体力的数值永久增加20%（与〖鹤墟重香〗同乘区）。<br>等于体力上限：每局游戏限一次，发动〖鹤墟重香②〗或〖月坠云微②〗时重置计数。当你使用牌对指定一名角色为唯一目标时，你与其交换体力与体力上限。以此法交换的体力和体力上限不超过X点（X为你发动〖鹤墟重香③〗的次数）<br>②每回合限1次，出牌阶段，若你有“蜃气”，你可以主动发动此技能：你失去所有“蜃气”，倒置负面强化并清除所有异常状态，召唤等量回合的“海市蜃楼”天气，令一名角色获得等量护盾，令一名角色回复等量体力（X=你的体力上限/2且向下取整）<br>③你永久免疫“睡眠”异常，永久免疫“海市蜃楼”的任何效果。",
            ...
            "zioy_yujin":"余烬",
            "zioy_yujin_info":"①获得此技能时你获得5点“烬”，若你有“烬”，限制你受到的伤害不超过1点且防止你失去体力。每次触发限伤或防止失去体力时你失去2点“烬”并在下次受到伤害后获得1点护甲。<br>②你的护甲被击破时，你恢复1点体力，弃置伤害来源至多2张牌并令其受到由你造成的1点火属性伤害。",
            "zioy_xumie":"虚灭",
            ...
            "zioy_yuemai":"岳衇",
            "zioy_yuemai_info":"锁定技，①你造成伤害后，若场上没有环境，则尝试召唤“迷嶂”环境8轮，召唤成功则获得2点护甲。<br>②“迷嶂”环境中你进攻距离+1，“迷嶂”环境下你获得50%免伤。",
            "zioy_liechenyuyou_water":"列辰御佑",
            "zioy_liechenyuyou_water_info":"血脉技，免疫失效。<br>①令你获得“泷之神佑”。<br>②你的摸牌阶段摸牌数+2，结束阶段与一轮游戏开始时你摸1张牌.<br>③你使用【杀】对非神势力非拥有“神佑”或拥有“燚之神佑”的角色造成的伤害+1。",
